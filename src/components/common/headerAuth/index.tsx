  ...
  const baseUrl = 'https://site-da-casa.vercel.app'
    ...
    <nav className={styles.nav}>
        <div className={styles.linksDiv}>
            ...
            <Link className="links" href='/area/myTasks'><span className={typeof window != 'undefined' ? (window?.location?.href  === `${baseUrl}/area/myTasks` ?  styles.linkSelected : styles.link) : styles.link }>Minhas tarefas</span></Link>
            <Link className="links" href='/area/allTasks'><span className={typeof window != 'undefined' ? (window?.location?.href  === `${baseUrl}/area/allTasks` ?  styles.linkSelected : styles.link): styles.link} >Tarefas</span></Link>
            </div>
        </div>
